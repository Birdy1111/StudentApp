...
public class ClassScheduleView extends View {
     ...
     * 标题分割线颜色
     */
    private int titleDividerColor = Color.parseColor("#80ff461f");
    /**
     * 标题文字颜色
     */
    private int titleTextColor = Color.parseColor("#80ff461f");
    /**
     * 标题左右箭头颜色
     */
    private int titleTextLeftRightColor = Color.parseColor("#80ff461f");
    /**
     * 标题左右箭头大小
     */
     ...
     * 日期时间颜色
     */
    private int dateTimeColor = Color.parseColor("#80ff461f");
    /**
     * 时间日期字体大小
     */
  ...
  /*  private String dateTime = "2018年07月23日 星期一 第23周";
    *//**
     * 星期行数据
     */
    private String rows[] = {"星期一", "星期二", "星期三", "星期四", "星期五"};
    /**
     * 星期行标记
     */
    private String columns[] = {"第一二节", "第三四节", "第五六节", "第七八节", "第九十节"};
    /**
     * 节列标记
     */
    private String columnBottoms[] = {"08:00~09:40", "10:00~11:40", "14:00~15:40","16:00~17:40","19:00~20:40"};
    ...
    public boolean onTouchEvent(MotionEvent event) {
        switch (event.getAction() & event.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_UP:
                addBackPressListener(event.getX(), event.getY());
     ...
     * @param upY
     */
    private void addBackPressListener(float upX, float upY) {
        //返回事件
